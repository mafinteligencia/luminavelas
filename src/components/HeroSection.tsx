  ...
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
      ...
      <motion.div
        ...
        style={{ backgroundColor: "#EDEADD" }}
      >
        <img src={logo} alt="Lumina Velas Artesanais" className="w-44 md:w-52 object-contain" />
      </motion.div>
      ...
      >
        ...
        <span className="text-gold">em experiências inesquecíveis</span>
      </motion.h1>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.97 }}
        className="inline-flex items-center gap-3 px-10 py-4 rounded-full text-sm font-semibold tracking-wider uppercase shadow-2xl transition-all duration-300 hover:shadow-gold/30"
        style={{
          background: "linear-gradient(135deg, hsl(38, 60%, 55%), hsl(30, 50%, 45%))",
          color: "#FFF",
        }}
      >
